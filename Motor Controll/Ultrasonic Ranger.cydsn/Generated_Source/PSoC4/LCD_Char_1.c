...
void LCD_Char_1_IsReady(void) 
{
    ...
    /* Clear LCD port*/
    LCD_Char_1_PORT_DR_REG &= ((uint32)(~LCD_Char_1_PORT_MASK));
    ...
    */
    ...
    /* Make sure RS is low */
    LCD_Char_1_PORT_DR_REG &= ((uint32)(~LCD_Char_1_RS));
    ...
    do
    {
        ...
        /* Set enable low */
        LCD_Char_1_PORT_DR_REG &= ((uint32)(~LCD_Char_1_E));
    ...
    LCD_Char_1_PORT_DR_REG &= ((uint32)(~LCD_Char_1_RW));
...
static void LCD_Char_1_WrDatNib(uint8 nibble) 
{
    ...
    /* Clear data pins */
    LCD_Char_1_PORT_DR_REG &= ((uint32)(~LCD_Char_1_DATA_MASK));
...
static void LCD_Char_1_WrCntrlNib(uint8 nibble) 
{
    ...
    LCD_Char_1_PORT_DR_REG &= ((uint32)(~(LCD_Char_1_RS | LCD_Char_1_RW)));
